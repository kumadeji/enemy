      ...
      <form className="apply-form" onSubmit={handleSubmit}>
        ...
        <fieldset className="form-section">
          ...
          <div className="callsign-rules">
            ...
            <ul>
              <li>✅ <b>Формат:</b> допускается использование латиницы, кириллицы, цифр и общепринятых символов (-, _, .).</li>
              <li>👁 <b>Читаемость:</b> должен легко считываться визуально и на слух. Избегайте сложных сочетаний, повторов и заглавных букв в середине слов.</li>
              <li>⚖️ <b>Содержание:</b> не должен содержать оскорблений, дискриминации, провокаций или нарушать законодательство России и других государств.</li>
            </ul>
            <p>🚫 <b>Запрещено:</b></p>
            <ul>
              <li>Реальные имена, фамилии и их производные (в т. ч. в транслите): Александр, Серёга, Dmitry.</li>
              <li>Указание имён в скобках, кавычках или через разделители: BURBON (Серёга), Wolf_Ivan.</li>
              <li>Бессмысленные наборы символов («абракадабра»): qwe123, кщгшз, xXx_Dark_xXx.</li>
              <li>Позывные из трёх и более слов (максимум 2 слова).</li>
            </ul>
            <p>📌 <b>Примеры корректных позывных:</b> Stormbreaker, Волчара, Фантом.</p>
          </div>
