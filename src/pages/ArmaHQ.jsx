...
export default function ArmaHQ() {
  return (
    <main className="container">
      ...
      <p className="page-lead">Раздел для навигации по инструментам направления Arma Reforger. Пока доступно только два инструмента, но раздел будет наполняться.</p>
      <div className="card">
